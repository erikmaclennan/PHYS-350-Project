...
specification = [ 1000, 0,0,0, 2,2,2, 0,0,0, 1,1,1, .2, 0,0,1];
...
for cluster = 1:clusters
    ...
    velocityCorrection = min(cross(repmat(angularVelocityCorrection, particleCount, 1), relativePosition).*abs(relativePosition).^-2,1);
